...
#theta_star_array = calculate_theta_star_array(theta_star)
#print(theta_star_array)
#apply_optimal_filter(theta_star_array, img14bl,"Filtered noisy image 1 (img14gn).tif")
...
#theta_star_array = calculate_theta_star_array(theta_star)
#print(theta_star_array)
#apply_optimal_filter(theta_star_array, img14bl,"Filtered noisy image 2 (img14sp).tif")
